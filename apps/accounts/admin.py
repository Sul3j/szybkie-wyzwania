...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ['username', 'email', 'first_name', 'last_name', 'is_staff', 'get_level', 'get_rank']
...
class UserProfileAdmin(admin.ModelAdmin):
    list_display = ['user', 'level', 'rank', 'experience_points', 'solved_count', 'created_at']
    list_filter = ['rank', 'level', 'created_at']
    search_fields = ['user__username', 'user__email']
    readonly_fields = ['experience_points', 'level', 'rank', 'created_at', 'updated_at', 'solved_count', 'total_submissions', 'acceptance_rate']
    fieldsets = (
        ('User Information', {
            'fields': ('user',)
        }),
        ('Gamification', {
            'fields': ('experience_points', 'level', 'rank')
        }),
        ('Statistics', {

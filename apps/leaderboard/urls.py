...
from .views import (GlobalLeaderboardView, LevelLeaderboardView,
                    ProblemSolversLeaderboardView, RankLeaderboardView,
                    StreakLeaderboardView, UserRankingView,
...
urlpatterns = [
    ...
    path(
        "solvers/", ProblemSolversLeaderboardView.as_view(), name="leaderboard-solvers"
    ),

...
class Submission(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="submission_set"
    )
    ...
    test_results = models.JSONField(
        null=True, blank=True, help_text="Detailed test case results"
    )
    ...
    memory_used = models.IntegerField(
        null=True, blank=True, help_text="Memory used in MB"
    )

    error_message = models.TextField(
        blank=True, null=True, help_text="Error message if submission failed"
    )
